...
-- 5. Muestra todos los clientes registrados después del 1 de enero de 2024. 6. Obtén todos los productos con un precio entre 100 y 500.
...
-- 11. Muestra los clientes y sus pedidos 
SELECT
...
-- 12. Obtiene todos lo pedidos junto con lo nombres de los productos y la cantidad de cada producto en esos pedidos. 
SELECT
	Pedidos.ID_Pedido,
