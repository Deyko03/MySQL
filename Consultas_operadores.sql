...
/*  Descripción: Esta consulta obtiene todos los regsitros de la tabla Clientes,
...
/*
JOIN conecta las tablas Clientes, Pedidos, Pedidos Productos, y Productos.
La consulta devuelve el nombre del cliente, el nombre del producto
que compro, la cantidad adquirida y la fecha en que se realizó el pedido. 
*/
SELECT
 ...
 JOIN Pedidos Productos ON Pedidos.ID_Pedido = Pedidos_Productos.ID_Pedido 
...
/*
NOT LIKE:
      Se utilizapara excluir un patrón en una cadena de texto. 
*/
